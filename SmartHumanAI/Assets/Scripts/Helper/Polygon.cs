...
namespace Helper
{
    public class PolygonHelper
    {
        ...
        public PolygonHelper(PointF[] points)
        {
            Points = points;
        }
        ...
        public List<Triangle> Triangulate()
        {
            ...
            PolygonHelper pgon = new PolygonHelper(pts);
        ...
        private void FindIntersection(float X1, float Y1, float X2, float Y2, float A1, float B1, float A2, float B2, ref PointF intersect)
        {
            float dx = X2 - X1;
            float dy = Y2 - Y1;
            float da = A2 - A1;
            ...
            if (Math.Abs(da * dy - db * dx) < 0.001) return;
        ...
        public PointF[] FindSmallestBoundingRectangle()
        {
            ...
            Debug.Assert(!PolygonIsOrientedClockwise());
